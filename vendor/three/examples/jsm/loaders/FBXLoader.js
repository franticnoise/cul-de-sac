...
function toWorkingColorSpaceCompat( color, sourceColorSpace ) {

	if ( ColorManagement && typeof ColorManagement.colorSpaceToWorking === 'function' ) {

		return ColorManagement.colorSpaceToWorking( color, sourceColorSpace );

	}

	if ( ColorManagement && typeof ColorManagement.toWorkingColorSpace === 'function' ) {

		return ColorManagement.toWorkingColorSpace( color, sourceColorSpace );
...
class FBXTreeParser {
	...
	parseParameters( materialNode, textureMap, ID ) {
		...
		if ( materialNode.Diffuse ) {
			...
			parameters.color = toWorkingColorSpaceCompat( new Color().fromArray( materialNode.Diffuse.value ), SRGBColorSpace );

		} else if ( materialNode.DiffuseColor && ( materialNode.DiffuseColor.type === 'Color' || materialNode.DiffuseColor.type === 'ColorRGB' ) ) {

			// The blender exporter exports diffuse here instead of in materialNode.Diffuse
			parameters.color = toWorkingColorSpaceCompat( new Color().fromArray( materialNode.DiffuseColor.value ), SRGBColorSpace );
		...
		if ( materialNode.Emissive ) {
			...
			parameters.emissive = toWorkingColorSpaceCompat( new Color().fromArray( materialNode.Emissive.value ), SRGBColorSpace );

		} else if ( materialNode.EmissiveColor && ( materialNode.EmissiveColor.type === 'Color' || materialNode.EmissiveColor.type === 'ColorRGB' ) ) {

			// The blender exporter exports emissive color here instead of in materialNode.Emissive
			parameters.emissive = toWorkingColorSpaceCompat( new Color().fromArray( materialNode.EmissiveColor.value ), SRGBColorSpace );
		...
		if ( materialNode.Specular ) {
			...
			parameters.specular = toWorkingColorSpaceCompat( new Color().fromArray( materialNode.Specular.value ), SRGBColorSpace );

		} else if ( materialNode.SpecularColor && materialNode.SpecularColor.type === 'Color' ) {

			// The blender exporter exports specular color here instead of in materialNode.Specular
			parameters.specular = toWorkingColorSpaceCompat( new Color().fromArray( materialNode.SpecularColor.value ), SRGBColorSpace );
	...
	createLight( relationships ) {
		...
		if ( lightAttribute === undefined ) {
			...
			if ( lightAttribute.Color !== undefined ) {
				...
				color = toWorkingColorSpaceCompat( new Color().fromArray( lightAttribute.Color.value ), SRGBColorSpace );
...
class GeometryParser {
	...
	parseVertexColors( ColorNode ) {
		...
		for ( let i = 0, c = new Color(); i < buffer.length; i += 4 ) {
			...
			toWorkingColorSpaceCompat( c, SRGBColorSpace );
			c.toArray( buffer, i );
